...
fixture('currency convertor')
  ...
  .before(async () => console.log('before hook'))
  .beforeEach(async () => console.log('before each hook'))
  .after(async () => console.log('after hook'))
  .afterEach(async () => console.log('after each hook'));
